...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-settings zmdi-hc-fw"></i>CUENTA DE USUARIO</small></h1>
	</div>
	<p class="lead">Actualizar datos de la CUENTA</p>
</div>
...
<?php
	...
	if (isset($datos[1]) && ($datos[1]=="admin" || $datos[1]=="user" || $datos[1]=="docente" || $datos[1]=="estudiante" ) )
	{
